        ...
        <div>
            ...
            <div className="mt-16 container mx-auto px-4">
                ...
                <div className="flex gap-8 flex-wrap justify-between">
                    {chef?.map((c) => (
                        <div className="bg-white rounded-lg shadow hover:shadow-xl w-full lg:w-[31.91%] ">
                            <img
                            ...
                            <div className="px-4">
                                ...
                                <div className="flex justify-between items-center mt-4">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <BsFillHeartFill
                                            style={{ fontSize: 22, color: 'text-red-500' }}
                                        />
                                        {c.likes}
                                    </div>
                                </div>
                            ...
                            <div className="mt-5">
                                <button className="bg-primary text-white py-4 px-6 w-full text-lg rounded-b-lg hover:bg-black duration-300">
                                    View Recipes
                                </button>
                            </div>
                        </div>
