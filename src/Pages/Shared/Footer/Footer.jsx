...
import { BsEnvelope, BsFacebook, BsFillTelephoneFill, BsInstagram, BsLinkedin, BsTwitter } from 'react-icons/bs';
import { Link } from 'react-router-dom';

function Footer() {
    return (
         <footer className="bg-[#333333] text-slate-300 mt-16">
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 container mx-auto px-4 justify-items-center-start lg:justify-items-center py-14 ">
                <div className="">
                    ...
                    <p className='mt-2'>A legendary chef is a culinary master who has achieved worldwide recognition and acclaim for their culinary expertise, creativity, and innovation.</p>
                ...
                <div>
                    ...
                    <p>14850-NY, USA</p>
                    <p className='flex items-center gap-1'><BsFillTelephoneFill /> : +1 607-266-7597</p>
                    <p className='flex items-center gap-1'><BsEnvelope /> : admin@legend-chef.com</p>
                </div>
            </div>
